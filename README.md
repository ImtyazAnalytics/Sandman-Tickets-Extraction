...
## Review-before-separation workflow

The PDF Project Sorter now works as:

1. Upload combined ticket PDFs.
2. AI detects a project for each page.
3. Review every page directly in the website.
4. Click a thumbnail / View Page for full preview.
5. Change Move To project if AI assigned it incorrectly.
6. Select multiple pages and bulk-move them.
7. Choose + New Project to create a project not already in the approved list.
8. Review all Other Pit Tickets first.
9. Click Finalize & Separate PDFs.
10. Download each project PDF or all as ZIP.

This specifically prevents valid project tickets from being permanently buried in the Other Pit Tickets file.
