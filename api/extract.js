...
7. Location = LOCATION.
8. Truck # = TRUCK NO.
9. Pit/Dump Vendor = vendor/pit/dump company shown on ticket. If none, use "Sandman".
10. Pit Ticket # = PIT TICKET NUMBER. If none, return "".
11. Driver = driver's handwritten or printed name in/near DRIVER'S SIGNATURE. Ignore an X/check mark.
12. Time Start = START time if filled.
13. Time Quit = QUIT time if filled.
14. Time Type = "Demurrage" if either start or quit time exists, otherwise "".
15. Material Type = DESCRIPTION OF COMMODITY.
16. Quantity = NET TONS OR YARDS. Prefer numeric value only.
17. Do not invent missing values except the two allowed Sandman defaults.
18. Preserve leading zeros in Truck # and Pit Ticket #.
19. One image = one ticket.
`;
